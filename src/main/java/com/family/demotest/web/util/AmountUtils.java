...
public class AmountUtils
{
    ...
    /*
     * public static double changeF2YI(double d) throws Exception{ return
     * Integer.parseInt(changeY2F(d)); }
     */
    /**
     * 抹零
     * 
     ...
     * @return
     */
    public static int paddingZero(int amount, int wei)
    {
        return (int)(amount-amount%Math.pow(10, wei));
    }
     ...
     * @return
     */
    public static int partLabeled(int amount, int wei)
    {
        return (int)(amount%Math.pow(10, wei));
    }
}
