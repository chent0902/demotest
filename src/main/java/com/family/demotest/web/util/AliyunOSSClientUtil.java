...
public class AliyunOSSClientUtil {
	...
	static{
		...
		ACCESS_KEY_ID = "LTAI5bLJC7UwfnxH";
		ACCESS_KEY_SECRET = "2iUwlRYY2u9Q7SvFaximkSYcZkyqVd";
		BACKET_NAME = "demotest";
		FOLDER = "xcx/";
	}
	 ...
	 * */
	public static  String uploadObject2OSS(OSSClient ossClient, InputStream is, String bucketName, String folder) {
		...
		try {
           ...
           // metadata.setContentDisposition("filename/filesize=" + fileName + "/" + fileSize + "Byte.");  
            //上传文件   (上传文件流的形式)
            PutObjectResult putResult = ossClient.putObject(bucketName, folder + "5555", is, metadata);  
			//解析结果
...
//		
		...
		//File filess=new File("D:\\upload\\1516333197031.png");
		
       // String md5key = AliyunOSSClientUtil.uploadObject2OSS(ossClient, is, BACKET_NAME, FOLDER);  
