...
import com.family.demotest.common.wxpay.WXPayConstants.SignType;
...
public class WXPay
{
     ...
     * @throws Exception
     */
    public Map<String, String> fillRequestData1(Map<String, String> reqData)
        throws Exception
    {
        // reqData.put("appid", config.getAppID());
        // reqData.put("mch_id", config.getMchID());
     ...
     * @throws Exception
     */
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs)
        throws Exception
    {
        String msgUUID = reqData.get("nonce_str");
        String reqBody = WXPayUtil.mapToXml(reqData);

        // if(BeanFactory.getBean(Logger.class).isDebugEnable()){
        // BeanFactory.getBean(Logger.class).info("请求微信接口参数:"+reqBody);
        // }
     ...
     * @throws Exception
     */
    public Map<String, String> payChange(String url, Map<String, String> reqData)
        throws Exception
    {

        Map<String, String> parmsMap = this.fillRequestData1(reqData);
        String msgUUID = reqData.get("nonce_str");
        String reqBody = WXPayUtil.mapToXml(parmsMap);
        String respXml = this.wxPayRequest.requestChange(url, msgUUID, reqBody, 6*1000, 8*1000, true);
        return WXPayUtil.xmlToMap(respXml);
